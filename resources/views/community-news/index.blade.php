...
@section('content')
<div class="container">
    <h1 class="my-4">LIYAHMÜLUNG</h1>

    <div id="community-news-container">
        @include('community-news.partials._news', ['communitys' => $communitys])
    </div>
...
<script>
    let page = {{ $page }};
    const limit = {{ $limit }};
    const apiUrl = '{{ route("community-news.loadMore") }}';
